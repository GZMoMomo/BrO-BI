...
import com.bro.bisystem.bi.service.defaultService.IDbListService;
...
public class DbListController {
   @Autowired
    ...
    public Dict add(DbList dbList){
        ...
        DatasourceConfigCache.INSTANCE.addConfig(dbList.getId(),dbList);
    ...
    public Dict update(DbList dbList){
        ...
        DatasourceConfigCache.INSTANCE.removeConfig(dbList.getId());
        DatasourceConfigCache.INSTANCE.addConfig(dbList.getId(),dbList);
